...
def Spravochnik(a, b):
    print('\nСправочник:')
    for _ in range(len(a)): print (f'ID = {a[_]}\tPHONE = {b[_]}')
...
Spravochnik(idcode, phone)
_ = Num('\nВарианты:\n\t1 - отсортировать по ID\n\t2 - отсортировать по PHINE\n\t3 - Вывести изначальный список\n\t0 - Выход\nВыберите дейстие', 0, 3)
match _:
    case 1: Zad1(idcode, phone, True); Spravochnik(idcode, phone)
    case 2: Zad1(idcode, phone, False); Spravochnik(idcode, phone)
    case 3: Spravochnik(idcode, phone)
...
match _:
    case 1: Zad1(kniga, god, True); Knigi(kniga, god)
    case 2: Zad1(kniga, god, False); Knigi(kniga, god)
    case 3: Knigi(kniga, god)
